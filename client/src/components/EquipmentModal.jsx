                              ...
                              return (
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    const price =
                                      parseFloat(updatedGroup[idx]["rate"]) ||
                                      0;
                                    const quantity =
                                      parseFloat(updatedGroup[idx]["number"]) ||
                                      0;

                                    if (
                                      updatedGroup[idx]["rate"] !== undefined &&
                                      updatedGroup[idx]["number"] !== undefined
                                    ) {
                                      updatedGroup[idx]["total_amt"] = (
                                        price * quantity
                                      ).toFixed(2);
                                    }
